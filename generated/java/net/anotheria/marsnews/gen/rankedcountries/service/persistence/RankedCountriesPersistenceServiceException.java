...
public class RankedCountriesPersistenceServiceException extends Exception{

	public RankedCountriesPersistenceServiceException(String message){
		super(message);
	}
	public RankedCountriesPersistenceServiceException(SQLException e){
		super("Undelying DB Error: "+e.getMessage());
	}
	public RankedCountriesPersistenceServiceException(DAOException e){
